...
import { SyncContactDto, SyncContactsResponseDto, SyncPlatform } from '../dto/syncing.dto';
...
export class SyncController extends BaseSocialController {
  ...
  @ApiOperation({
    ...
    description: 'Đồng bộ danh bạ từ Facebook, LINE, hoặc Contact và tự động kết bạn với CashPop users'
  })
  @ApiResponse({
    status: 200,
